...
curl -X POST "http://$RESTSERVER:1024/spider/region" -H 'Content-Type: application/json' -d '{"RegionName":"gcp-taiwan-region","ProviderName":"GCP", "KeyValueInfoList": [{"Key":"Region", "Value":"asia-east1"},{"Key":"Zone", "Value":"asia-east1-a"}]}'

 # for Cloud Connection Config Info
curl -X POST "http://$RESTSERVER:1024/spider/connectionconfig" -H 'Content-Type: application/json' -d '{"ConfigName":"gcp-taiwan-config","ProviderName":"GCP", "DriverName":"gcp-driver01", "CredentialName":"gcp-credential01", "RegionName":"gcp-taiwan-region"}'
