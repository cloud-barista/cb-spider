...
curl -X POST http://$RESTSERVER:1024/credential -H 'Content-Type: application/json' -d '{"CredentialName":"aws-credential01","ProviderName":"AWS", "KeyValueInfoList": [{"Key":"ClientId", "Value":"AKIASHSDBYRCS3Z6FRGX"}, {"Key":"ClientSecret", "Value":"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"}]}'
