...
# for AWS:VM:Docker
curl -X POST http://$RESTSERVER:1024/spider/credential -H 'Content-Type: application/json' -d '{"CredentialName":"docker-credential01","ProviderName":"DOCKER", "KeyValueInfoList": [{"Key":"Host", "Value":"http://18.191.xxx.xxx:1004"}, {"Key":"APIVersion", "Value":"v1.38"}]}'
# for powerkim:NAS:Docker
curl -X POST http://$RESTSERVER:1024/spider/credential -H 'Content-Type: application/json' -d '{"CredentialName":"docker-credential02","ProviderName":"DOCKER", "KeyValueInfoList": [{"Key":"Host", "Value":"http://129.254.xxx.xxx:1004"}, {"Key":"APIVersion", "Value":"v1.38"}]}'
