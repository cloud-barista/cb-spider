...
curl -X POST http://$RESTSERVER:8000/spider/credential -H 'Content-Type: application/json' -d '{"CredentialName":"aws-credential01","ProviderName":"AWS", "KeyValueInfoList": [{"Key":"ClientId", "Value":"AKIAZH5OR44ML3FBA72U"}, {"Key":"ClientSecret", "Value":"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"}]}'
