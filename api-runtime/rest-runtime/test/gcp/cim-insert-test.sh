...
curl -X POST "http://$RESTSERVER:1024/credential" -H 'Content-Type: application/json' -d '{"CredentialName":"gcp-credential01","ProviderName":"GCP", "KeyValueInfoList": [{"Key":"PrivateKey", "Value":""},{"Key":"ProjectID", "Value":"mcloud-barista-251102"}, {"Key":"ClientEmail", "Value":"675581125193-compute@developer.gserviceaccount.com"}]}'
