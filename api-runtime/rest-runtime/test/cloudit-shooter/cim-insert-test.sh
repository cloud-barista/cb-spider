...
curl -X POST http://$RESTSERVER:1024/spider/credential -H 'Content-Type: application/json' -d '{ "CredentialName":"cloudit-credential01", "ProviderName":"CLOUDIT", "KeyValueInfoList": [{"Key":"IdentityEndpoint", "Value":"http://xxx.xxx.xxx:9090"}, {"Key":"AuthToken", "Value":"xxxxxxxxxxxxx"}, {"Key":"Username", "Value":"xxxxxxx"}, {"Key":"Password", "Value":"xxxxxxx"}, {"Key":"TenantId", "Value":"tnt0009"}]}'
