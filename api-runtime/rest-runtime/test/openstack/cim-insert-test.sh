...
curl -X POST http://$RESTSERVER:1024/credential -H 'Content-Type: application/json' -d '{"CredentialName":"openstack-credential01","ProviderName":"OPENSTACK","KeyValueInfoList": [{"Key":"IdentityEndpoint", "Value":"http://182.252.135.150:5000/v3"},{"Key":"Username", "Value":"admin"},{"Key":"Password", "Value":"qwe1212!Q"},{"Key":"DomainName", "Value":"default"},{"Key":"ProjectID", "Value":"7b50974d16304341975728fb0571851b"}]}'
