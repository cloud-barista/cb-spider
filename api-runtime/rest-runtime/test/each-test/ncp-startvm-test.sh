...
# curl -sX POST http://localhost:1024/spider/vm -H 'Content-Type: application/json' -d '{ "ConnectionName": "'${CONN_CONFIG}'", "ReqInfo": { "Name": "'${CONN_CONFIG}'-vm-02", "ImageName": "'${IMAGE_NAME}'", "VMSpecName": "'${SPEC_NAME}'", "KeyPairName": "'${KEYPAIR_NAME}'" } }' |json_pp
