...
echo "## 1. VPC: Create -> Add-Subnet -> List -> Get"
echo "####################################################################"
$CBSPIDER_ROOT/interface/spiderctl vpc create --config $CBSPIDER_ROOT/interface/grpc_conf.yaml -i json -d \
    '{ 
...
$CBSPIDER_ROOT/interface/spiderctl vpc add-subnet --config $CBSPIDER_ROOT/interface/grpc_conf.yaml -i json -d \
    '{ 
      "ConnectionName":"'${CONN_CONFIG}'",
      "VPCName": "vpc-01", 
      "ReqInfo": { 
...
$CBSPIDER_ROOT/interface/spiderctl vpc list --config $CBSPIDER_ROOT/interface/grpc_conf.yaml --cname "${CONN_CONFIG}"

$CBSPIDER_ROOT/interface/spiderctl vpc get --config $CBSPIDER_ROOT/interface/grpc_conf.yaml --cname "${CONN_CONFIG}" -n vpc-01
...
echo "## 2. SecurityGroup: Create -> List -> Get"
echo "####################################################################"
$CBSPIDER_ROOT/interface/spiderctl security create --config $CBSPIDER_ROOT/interface/grpc_conf.yaml -i json -d \
    '{ 
      "ConnectionName":"'${CONN_CONFIG}'",
      "ReqInfo": { 
        "Name": "sg-01", 
...
$CBSPIDER_ROOT/interface/spiderctl security list --config $CBSPIDER_ROOT/interface/grpc_conf.yaml --cname "${CONN_CONFIG}"

$CBSPIDER_ROOT/interface/spiderctl security get --config $CBSPIDER_ROOT/interface/grpc_conf.yaml --cname "${CONN_CONFIG}" -n sg-01
...
echo "## 1. VPC: Remove-Subnet -> Delete"
echo "####################################################################"
$CBSPIDER_ROOT/interface/spiderctl vpc remove-subnet --config $CBSPIDER_ROOT/interface/grpc_conf.yaml --cname "${CONN_CONFIG}" --vname vpc-01 --sname subnet-02 --force false
