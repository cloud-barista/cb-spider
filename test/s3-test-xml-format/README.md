# CB-Spider S3 API Test (XML Format)

Automated test suite for CB-Spider S3 API endpoints with XML response format.
...
- Tests use bucket name pattern: `cb-spider-test-xml-{timestamp}`
- XML format responses are validated
