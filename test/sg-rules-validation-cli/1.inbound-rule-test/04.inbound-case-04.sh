...
echo "============== before AddRules: '${SG_NAME}' --- inbound:TCP/1000/1000"
...
echo "============== after AddRules: '${SG_NAME}' --- inbound:TCP/1000/1000"
...
./io-traffic-test.sh $1    pass    pass      skip     fail         pass     pass     pass    pass
