...
curl -u $API_USERNAME:$API_PASSWORD -X DELETE http://$RESTSERVER:1024/spider/credential/alibaba-credential01 \
    -H 'Content-Type: application/json'
...
curl -u $API_USERNAME:$API_PASSWORD -X DELETE http://$RESTSERVER:1024/spider/driver/alibaba-driver01 \
    -H 'Content-Type: application/json'
