...
curl -u $API_USERNAME:$API_PASSWORD -X DELETE "http://$RESTSERVER:1024/spider/credential/gcp-credential01" \
    -H 'Content-Type: application/json'
...
curl -u $API_USERNAME:$API_PASSWORD -X DELETE "http://$RESTSERVER:1024/spider/driver/gcp-driver01" \
    -H 'Content-Type: application/json'
