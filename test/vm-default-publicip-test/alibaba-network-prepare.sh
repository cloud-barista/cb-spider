...
# Alibaba Basic Resource Prepare Script (VPC/Subnet -> SecurityGroup -> KeyPair)
...
export RESULT_FILE="${RESULT_DIR:-/tmp/vm_publicip_network_results}/result_alibaba.txt"
