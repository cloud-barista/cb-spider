...
# CB-Spider VM AssignPublicIP=false Test - VM Delete Runner for All CSPs
# Terminates the 'cb-spider-nopublicip-test' VM on all 10 CSPs in parallel
...
export RESULT_DIR="/tmp/vm_nopublicip_delete_results_$$"
LOG_DIR="/tmp/vm_nopublicip_delete_logs_$$"
...
echo ""
echo "################################################################################"
echo "#   CB-Spider VM AssignPublicIP=false Test - VM Delete - All CSPs             #"
echo "################################################################################"
echo ""
...
echo "============================================================"
echo "          VM DELETE SUMMARY - ALL CSPs (AssignPublicIP=false)"
echo "============================================================"
echo ""
