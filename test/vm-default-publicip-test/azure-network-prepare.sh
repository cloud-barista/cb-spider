...
# Azure Basic Resource Prepare Script (VPC/Subnet -> SecurityGroup -> KeyPair)
...
export SUBNET_JSON='[{"Name": "subnet-01", "IPv4_CIDR": "192.168.0.0/23"}]'
export SG_NAME="sg-01"
export KEYPAIR_NAME="keypair-01"
export RESULT_FILE="${RESULT_DIR:-/tmp/vm_publicip_network_results}/result_azure.txt"
