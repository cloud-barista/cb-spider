...
# CB-Spider VM Default-PublicIP Test - Common Delete Script
# Terminates the VM instance and waits until it is fully removed.
...
#   MAX_WAIT_SEC    - Max seconds to wait for deletion (default: 900)
...
echo "[${CSP_NAME}] [${timestamp}] Deleting VM '${VM_NAME}'..."
...
echo "[${CSP_NAME}] DELETE accepted. Waiting for removal..."
...
while true; do
    ...
    echo "[${CSP_NAME}] Still present (elapsed: ${elapsed}s)"
