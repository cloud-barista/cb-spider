...
type VCpuInfo struct {
	Count string `json:"Count" validate:"required" example:"2"`              // Number of CPU cores, "-1" when not applicable
	Clock string `json:"Clock,omitempty" validate:"omitempty" example:"2.5"` // Clock speed in GHz, "-1" when not applicable
}
