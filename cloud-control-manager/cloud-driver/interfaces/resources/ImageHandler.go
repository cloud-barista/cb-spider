...
type ImageInfo struct {
	...
	DiskType       string `json:"DiskType" validate:"required" example:"gp3" description:"The type of the disk of the image."`                                     // gp3, etc.
	DiskSize       string `json:"DiskSize" validate:"required" example:"35" description:"The size of the disk of the image."`                                      // 35, etc., GB
