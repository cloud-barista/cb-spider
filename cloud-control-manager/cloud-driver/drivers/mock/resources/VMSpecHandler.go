...
func PrepareVMSpec(mockName string) {
	...
	prepareVMSpecInfoList = []*irs.VMSpecInfo{
		{"common-region", "mock-vmspec-01", irs.VCpuInfo{"4", "2.7"}, "32768", "-1", []irs.GpuInfo{{"2", "NVIDIA", "V100", "16384MB"}}, nil},
		{"common-region", "mock-vmspec-02", irs.VCpuInfo{"4", "3.2"}, "32768", "-1", []irs.GpuInfo{{"1", "NVIDIA", "V100", "16384MB"}}, nil},
