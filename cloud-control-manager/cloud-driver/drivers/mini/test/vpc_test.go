...
var vpcTestInfoList = []VPCTestInfo{
	{"mini-vpc-name01", "10.0.1.0/24", "mini-subnet-01", "10.0.1.0/24"},
	{"mini-vpc-name02", "10.0.2.0/24", "mini-subnet-01", "10.0.1.0/24"},
	{"mini-vpc-name03", "10.0.3.0/24", "mini-subnet-01", "10.0.1.0/24"},
	{"mini-vpc-name04", "10.0.4.0/24", "mini-subnet-01", "10.0.1.0/24"},
	{"mini-vpc-name05", "10.0.5.0/24", "mini-subnet-01", "10.0.1.0/24"},
}
...
var subnetTestInfoList = []SubnetTestInfo{
	{"mini-vpc-name01", "mini-subnet-02", "10.0.2.0/24"},
	{"mini-vpc-name01", "mini-subnet-03", "10.0.3.0/24"},
}
