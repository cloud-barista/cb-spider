		...
		if inputCnt == 1 {
			...
			case 1:
				vmReqInfo := irs.VMReqInfo{
					...
					IId: irs.IID{NameId: "myVM-01"},

					// $$$ Needs NHN Cloud VPC 'SystemId'
					VpcIID: irs.IID{
						NameId:   "nhn-vpc-1",
						SystemId: "e4553f0c-b9a0-430d-818f-da49945f2984",
					},

					SubnetIID: irs.IID{
						NameId:   "nhn-subnet-1",
						SystemId: "51fd3f4e-dad5-407b-8207-151d10d425d0",
					},

					SecurityGroupIIDs: []irs.IID{{NameId: "nhn-sg-1", SystemId: "8b388b69-0e39-42e5-9f51-d9e508c3ed04"}},
					// SecurityGroupIIDs: []irs.IID{{SystemId: "79965cd0-b9e9-42ef-9c66-201f824273cb"},{SystemId: "67167e2e-2390-48d6-8f27-78c9293b26f3"}},

					// KeyPairIID: irs.IID{NameId: "ohkeypair-0-coed8r4vtts22sf78g60"},
					...
					// ImageIID: irs.IID{NameId: "Ubuntu Server 22.04.3 LTS (2023.11.21)", SystemId: "517d3d51-c86e-4dd5-870a-a729d75a423a"}, // My Image

					//KR2
					ImageIID: irs.IID{NameId: "Ubuntu Server 24.04.2 LTS (2025.07.15)", SystemId: "a727b80a-ed4b-4d71-973f-8d57a08910e0"},
