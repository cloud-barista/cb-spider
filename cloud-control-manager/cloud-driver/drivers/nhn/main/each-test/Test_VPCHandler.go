...
func handleVPC() {
	...
	for {
		...
		// KR1
		vpcIId := irs.IID{SystemId: "bb51142b-4380-4680-a3cc-98735af953c3"}

		// KR2
		// vpcIId := irs.IID{SystemId: "89e4031d-78c1-4e7c-83ae-8024a02a7cb1"}
...
func getResourceHandler(handlerType string) (interface{}, error) {
	...
	cblogger.Infof("# NHN Cloud Region : [%s]", config.NhnCloud.Region)
